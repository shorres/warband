...
export const soldierTypes = [HERETIC_PRIEST, HERETIC_DEATH_COMMANDO, HERETIC_CHORISTER,
  HERETIC_TROOPER,HERETIC_LEGIONNAIRE,ANOINTED_HEAVY_INFANTRY,WAR_WOLF_ASSAULT_BEAST,ARTILLERY_WITCH,WRETCHED,
  ...
  PRAETOR,SORCERER,HUNTER_OF_THE_LEFT_HAND_PATH,HELL_KNIGHT,YOKE_FIEND,PIT_LOCUST,DESECRATED_SAINT];
