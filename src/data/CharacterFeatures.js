...
export const abilities = [ANIMAL, NO_CARRY, HAND_WEAPON, DAGGER, STAFF, LEATHER_ARMOUR, CROSSBOW, TWO_HANDED_WEAPON, SHIELD, MAIL_ARMOUR, START_WITH_HEALING_POTION, BOW, UNARMED];
